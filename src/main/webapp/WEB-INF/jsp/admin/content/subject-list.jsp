...
<h3>
	<spring:message code="label.subjectList" />
</h3>
<h4>${errorMsg}</h4>
<form action="/QuizSystem/jsp/subject/add" method="post">
	<input type="submit"
		value="<spring:message code="label.subjectList.addSubject" />"
	...
	<c:forEach var="subject" items="${subjectList}">
		<tr>
			...
			<td><form action="/QuizSystem/jsp/subject/edit">
					<input type="submit"
						value="<spring:message code="label.subjectList.edit" />"
						class="btn btn-primary" />
			...
			<td><form action="/QuizSystem/jsp/subject/remove" method="post">
					<input type="submit"
						value="<spring:message code="label.subjectList.remove" />"
						class="btn btn-primary" />
					<input type="hidden" name="subjectId" value="${subject.id}"
						required>
				</form></td>
